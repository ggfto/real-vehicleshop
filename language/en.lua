Locales["en"] = {
    ...
    ["company"] = "Company",
    ["vehicles"] = "Vehicles",
    ["feedbackcomplains"] = "Feedback & Complaints",
    ["company_settings"] = "Company Settings",
    ["vehicle_stock"] = "Vehicle Stock",
    ["vehicle_stock_description"] = "Here you can see the stock of vehicles in your company.",
    ["vehicle_stock_list_description"] = "List of vehicles in your company.",
    ...
    ["transfer_company_description"] = "You can transfer your company to someone else by writing ID.",
    ["transfer"] = "Transfer",
