...
Config.VehiclesData = {
    ['car'] = {
        ...
        { name = 'feltzer', label = 'Feltzer', model = '', price = 145000, stock = 1, img = 'https://docs.fivem.net/vehicles/feltzer.webp', category = 'sports', discount = 0, information = {TopSpeed = 225, Braking = 91, Acceleration = 82, Suspension = 85, Handling = 83} },
    ...
    ['boat'] = {
        ...
        { name = 'marquis', label = 'Marquis', model = 'Luxury', price = 150000, stock = 1, img = 'https://docs.fivem.net/vehicles/marquis.webp', category = 'all', discount = 0, information = {TopSpeed = 220, Braking = 85, Acceleration = 80, Suspension = 85, Handling = 80} },
        ...
        { name = 'tug', label = 'Tug', model = 'Heavy', price = 120000, stock = 1, img = 'https://docs.fivem.net/vehicles/tug.webp', category = 'all', discount = 0, information = {TopSpeed = 200, Braking = 80, Acceleration = 70, Suspension = 80, Handling = 75} },
        ...
        { name = 'marquis2', label = 'Marquis 2', model = 'Luxury', price = 160000, stock = 1, img = 'https://docs.fivem.net/vehicles/marquis2.webp', category = 'all', discount = 0, information = {TopSpeed = 225, Braking = 86, Acceleration = 81, Suspension = 86, Handling = 81} }
    },
