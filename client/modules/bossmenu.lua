...
RegisterNetEvent(
    ...
    function(src, targetsrc, id, price)
        SendNUIMessage(
            {
...
RegisterNetEvent(
    "real-vehicleshop:CloseBossmenu",
    function()
...
RegisterNetEvent(
    "real-vehicleshop:CloseTransferReqForTarget",
    function()
        SendNUIMessage({action = "CloseTransferReq"})
...
RegisterNetEvent(
    ...
    function(src, targetsrc, id, salary)
        SendNUIMessage(
            {
...
RegisterNetEvent(
    "real-vehicleshop:CloseJobReqScreen",
    function()
...
RegisterNetEvent(
    "real-vehicleshop:CloseBossPopup",
    function(type)
        SendNUIMessage(
            {
...
RegisterNetEvent(
    "real-vehicleshop:ShowFeedbackScreen",
    function(data)
        SendNUIMessage(
            {
